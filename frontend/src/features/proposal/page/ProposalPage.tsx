            ...
            {showRaiseIssue && hasActiveService && (
                <div>
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 text-sm font-Jost-Semibold px-4 py-2.5 rounded-lg bg-accent text-text-on-accent   hover:bg-accent-hover transition-all duration-200"
                    >
                        Raise an Issue
                    </button>
                </div>
