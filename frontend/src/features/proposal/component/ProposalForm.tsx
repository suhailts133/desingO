...
export default function ProposalForm() {
    ...
    if (!sourceId) {
        return (
            <div className="w-full p-10 text-center text-error font-Jost-Semibold">
    ...
    if (isLoading) {
        return (
            <div className="w-full p-10 text-center animate-pulse text-text-faint">
                Loading...
            </div>
        )
    }
    ...
    return (
        <div className="w-full flex flex-col gap-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="font-Jost-Semibold text-xl text-text-primary">Create proposal</h1>
