...
import OngoingDisputesSection from "../component/OngoingDisputesSection"
import OngoingProposalsSection from "../component/OngoingProposalsSection"
    ...
    return (
        <div className="w-full max-w-7xl flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <OngoingDisputesSection disputes={dashboardData.ongoingDisputes} />
                <OngoingProposalsSection proposals={dashboardData.ongoingProposals} />
            </div>
        </div>
    )
}