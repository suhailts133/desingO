    ...
    return (
        <div className="relative" ref={panelRef}>
            <button
                ...
                className="relative flex items-center justify-center hover:text-blush-deep transition-colors duration-200"
                aria-label="Notifications"
            >
                <Bell size={16} className="sm:hidden" />
                <Bell size={18} className="hidden sm:block" />
                {unreadCount > 0 && (
                    <span className="absolute -top-1.5 -right-2 min-w-4 h-4 px-1 rounded-full bg-blush-deep text-off-white text-xxs font-semibold flex items-center justify-center">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-3 w-80 max-h-112 bg-off-white text-soft-black rounded-xl border border-blush-light/40 shadow-2xl overflow-hidden flex flex-col z-50 font-normal">
