    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <InputField label="PIN Code" placeholder="6-digit PIN" registration={register("pincode")} error={errors.pincode?.message} />
                <InputField label="Phone Number" placeholder="+91 XXXXXXXXXX" registration={register("phone")} error={errors.phone?.message} />
            </div>
