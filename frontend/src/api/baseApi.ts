...
export const baseApi = createApi({
    reducerPath: "api",
    tagTypes:["designerDashboard","disputeNormal", "customerDispute", "dispute", "users","designerRequests", "designs", "jobs", "myJobApplications", "jobApplications", "savedDesigns", "proposal", "hireRequest"],
