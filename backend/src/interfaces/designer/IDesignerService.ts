...
export interface IJobApplicationService {
    ...
    getMyJobApplications(userId: string, filters?: JobAllicationFilter): Promise<IApiResponseWithPagination<MyJobApplicationsDTO[]>>
    getAllJobApplications(filters?: JobAllicationFilter): Promise<IApiResponseWithPagination<AllJobApplicationsDTO[]>>
}