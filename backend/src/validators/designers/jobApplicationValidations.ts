...
export const jobApplicationApprovalOrRejectionValidation: Joi.ObjectSchema<JobApplicationApprovalOrRejectionRequestDTO> =
    Joi.object<JobApplicationApprovalOrRejectionRequestDTO>({
        status: Joi.string()
